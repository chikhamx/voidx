...
export const COMMAND_CATALOG: SlashCommand[] = [
  ...
  { command: "/goal", description: "Switch to goal mode or manage the current goal", category: "permission", execution: "fill", dangerous: false, requiresArgs: false },
  ...
  { command: "/loop", description: "Switch to loop mode or manage the current loop", category: "maintenance", execution: "fill", dangerous: false, requiresArgs: false },
