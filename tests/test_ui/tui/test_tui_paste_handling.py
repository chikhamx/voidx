...
def test_paste_clipboard_image_inserts_image_token(tmp_path, monkeypatch):
    ...
    monkeypatch.setattr("voidx_tui.app.paste_clipboard_image_from_system", fake_paste)
    tui = _tui(tmp_path)
...
def test_ctrl_v_pastes_clipboard_image_when_available(tmp_path, monkeypatch):
    ...
    monkeypatch.setattr("voidx_tui.app.paste_clipboard_image_from_system", fake_paste_image)
    monkeypatch.setattr("voidx_tui.app.paste_clipboard_text_from_system", fail_text_paste)
    tui = _tui(tmp_path)
...
def test_ctrl_v_falls_back_to_clipboard_text_when_no_image(tmp_path, monkeypatch):
    ...
    monkeypatch.setattr("voidx_tui.app.paste_clipboard_image_from_system", fake_paste_image)
    monkeypatch.setattr("voidx_tui.app.paste_clipboard_text_from_system", fake_paste_text)
    tui = _tui(tmp_path)
