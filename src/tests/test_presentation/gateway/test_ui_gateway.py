...
from voidx.presentation.output.events.schema import AssistantStreamUpdated, RefreshRequested, TurnStarted
...
from voidx.presentation.protocol.requests import UiChoiceRequest, UiResponse, UiTextRequest
...
async def test_composite_event_consumer_handle_direct_logs_async_mirror_error(monkeypatch):
    ...
    monkeypatch.setattr(
        "voidx.presentation.output.events.consumers.log_internal_error",
