...
from voidx.lsp.errors import LspFormattingUnsupported, LspTimeoutError
from voidx.tools.base import ToolContext
from voidx.tools.file.post_edit import format_after_edit, format_range_from_diff
...
async def test_format_after_edit_returns_actual_disk_text_on_commit_conflict(tmp_path):
    ...
    result = await format_after_edit(
        ToolContext(workspace=str(tmp_path), lsp_manager=Manager()),
        target,
        display_path="sample.py",
