...
from voidx.tooling.builtin.file import FileReadInput, FileReplaceInput, WriteInput, FileReadTool, WriteTool, FileReplaceTool, ManageTool
...
class TestToolSchemas:
    ...
    def test_tool_registry_requires_id_and_description(self):
        class BadTool:
    ...
    def test_model_to_json_schema_flattens_anyof(self):
        ...
        from voidx.tooling.builtin.file.manage import ManageInput
    ...
    def test_message_payload_schema_disallows_extra_properties(self):
        from voidx.tooling.domain.schema import model_to_json_schema
        from voidx.agent.adapters.tools.subagent_message import MessageInput
    ...
    def test_replace_anyof_preserves_null_and_array_types(self):
        from voidx.tooling.domain.schema import _replace_anyof
