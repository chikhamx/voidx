...
from voidx.lsp.domain.schema import file_uri, parse_document_symbols, parse_locations
from voidx.lsp.ports.client import LSP_REQUEST_TIMEOUT_SECONDS, LspClient, LspClientFactory
from voidx.platform.paths import resolve_tool_path as _resolve_tool_path


class LspManager:
    def __init__(self, workspace: str, client_factory: LspClientFactory) -> None:
