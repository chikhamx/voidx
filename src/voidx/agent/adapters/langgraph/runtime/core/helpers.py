...
def _render_inline_compaction_guide(*, tail_anchor_id: str, head_count: int, previous_summary: str) -> str:
    ...
    return (
        ...
        "The conversation is large enough for the runtime to compact older context without a separate compaction request.\n"
        "Continue the user's request with the remaining live context. Do not call a compact tool.\n\n"
        "Rules:\n"
        "- Treat older context before the tail anchor as already eligible for runtime compaction.\n"
        ...
        "- Do not answer the user by summarizing older context; keep working on the current request.\n"
        "- After the runtime compacts, continue with the user's request normally.\n\n"
