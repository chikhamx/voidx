...
class ExecutionHost(Protocol):
    ...
    def bind_coding_turn_runner(self, runner: Any) -> None: ...
    async def run_coding_turn(self, text: str, *, display_text: str | None = None) -> None: ...
    ...
    def runtime_snapshot(self) -> SessionRuntimeState: ...
