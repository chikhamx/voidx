"""Stable display labels for subagent identities."""
...
SUBAGENT_DISPLAY_NAMES: tuple[str, ...] = (
    "Athena", "Orion", "Nova", "Lyra", "Vega", "Quill", "Pixel", "Cipher",
    "Echo", "Flux", "Helix", "Iris", "Juno", "Kai", "Lumen", "Mira",
    "Nexus", "Onyx", "Prism", "Rune", "Sol", "Tess", "Umbra", "Vesper",
)
