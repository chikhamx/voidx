...
class GraphToolExecutionHost(Protocol):
    ...
    _workflow_repeat_tracker: dict[str, dict[str, int]]
    _turn_node: Any | None
...
class GraphPermissionHost(Protocol):
    ...
    async def _ask_tool_permission(self, tool_calls: list[dict] | list[PermissionDecision]) -> str | None: ...
...
class GraphRunLoopHost(Protocol):
    ...
    async def _handle_user_input(self, app: Any, user_input: str, *, context: Any | None = None, thread_id: str = "") -> tuple[bool, str | None]: ...
    async def _run_once(self, user_text: str, *, display_text: str | None = None, context: Any | None = None) -> None: ...
    ...
    def _skill_service_for_references(self) -> Any: ...
