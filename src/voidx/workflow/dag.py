...
DEFAULT_WORKFLOW_DAG = WorkflowDAG(
    ...
    edges=[
        Edge(source="brainstorm", target="design-doc", condition="approved", label="design approved", description="Use after explicit user approval when a design document is needed."),
