...
from voidx.tools.file_ops import FileDeleteTool, FileReadTool, FileWriteTool, FileEditTool, FileInsertTool, FileReplaceTool
...
class ToolRegistry:
    ...
    def _register_builtins(self) -> None:
        for cls in [
            FileDeleteTool, FileReadTool, FileWriteTool, FileEditTool, FileInsertTool, FileReplaceTool,
            GitTool,
            RepoMapTool,
