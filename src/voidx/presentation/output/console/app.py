...
from voidx.presentation.output.display_policy import ToolDisplayMode, ToolDisplayPolicy, ToolDisplayRule
...
class VoidConsole:
    ...
    def _get_display_rule(self, tool_name: str) -> ToolDisplayRule:
        from voidx.presentation.output.display_policy import ToolDisplayPolicy, DEFAULT_DISPLAY_RULES
    ...
    def diff(self, diff_text: str, title: str = "") -> None:
        from voidx.presentation.output.diff import render_diff
        if via_events():
